function test_pred=SVM_Guassian(train_data,train_label,C,test_data,gamma)
...
% Step2: Guassian kernel construction
kernel=@(x,y) exp(-gamma*(x'-y)'*(x'-y));
...
alpha = quadprog(H_matrix, f, A, b, Aeq, beq, lb, ub,x0,options);
